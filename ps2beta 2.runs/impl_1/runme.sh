...
HD_PWD='C:/Users/Calin/Desktop/dsd/ps2beta 2/ps2beta 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TheBigSource.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TheBigSource.tcl -notrace
